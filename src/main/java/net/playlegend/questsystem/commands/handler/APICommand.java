...
public abstract class APICommand extends Command {
     ...
     * @return Collection ({@link net.playlegend.questsystem.commands.handler.APISubCommand}).
     * @since 0.0.1
     */
     ...
     * @param subCommand {@link net.playlegend.questsystem.commands.handler.APISubCommand} - the subcommand to add.
     * @since 0.0.1
     */
