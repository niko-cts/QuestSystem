...
public class TranslationMessageHolder {
	...
	public TranslationMessageHolder(String translationKey, String placeholders, Object replacements) {
		this(translationKey, List.of(placeholders), List.of(replacements));
	}
